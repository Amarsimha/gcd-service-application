...
public class GcdAppSecurityConfig extends WebSecurityConfigurerAdapter {
	@Autowired
	private SoapAuthenticationEntryPoint soapAuthenticationEntryPoint;
	
	static String REALM="GCD_OUTPUT_REALM";
	...
	protected void configure(HttpSecurity http) throws Exception {
	  ...
	  http.csrf().disable()
		...
		.and().httpBasic().realmName(REALM).authenticationEntryPoint(soapAuthenticationEntryPoint);
 	}
